...
tóm gọn trong \autoref{fig:kotlin-coroutine}. Dù khá mới (Martin Sústrik, tác
giả của ZeroMQ, đưa ra ý tưởng này năm 2016) và còn tranh cãi, mô hình này vẫn
được cải thiện liên tục, có thư viện ở nhiều ngôn ngữ như Java (Loom), Python
(Trio),\ldots{} Điều này cho thấy ý tưởng có tiềm năng lớn, giúp đơn giản hóa tư
duy về tương tranh.
...
\section{Mẫu thiết kế MVVM và Kiến trúc Google khuyên dùng}\label{sec:mvvm-app-arch}
...
\begin{enumerate}
    ...
    \item
        Các từ được đưa vào chỉ mục đảo, với khóa là chính từ đó, còn giá trị là
        khóa đại diện \texttt{rowid}.
\end{enumerate}
