...
\begin{itemize}
    ...
    \item
        ...
        loa,\ldots), giúp các tầng trên có thể dùng phần cứng mà không quan tâm
        đến chi tiết riêng.
    \item
        Android Runtime (ART):
...
\begin{itemize}
    \item
        ...
        (class) thông thường, rồi đánh dấu với Annotation và interface của Room.
        Sau đó, Room sinh các bảng tương ứng.
    \item
...
trong tệp ZIP) nhanh nhất có thể. Mục tiêu đó dẫn đến thiết kế sau
\cite{PKWARE_APPNOTE}, được thể hiện trong \autoref{fig:zip-layout}:
