...
\begin{enumerate}
    \item Dựa trên tệp: đọc phần mục lục trước, sau đó giải nén bất kì tệp nén
        lẻ nào một cách nhanh chóng (có thể gọi là ``nhảy cóc'')
    \item Dựa trên luồng: đọc lần lượt (do đó chậm) từng tệp nén lẻ theo luồng
        đọc, đồng thời phải giải nén toàn bộ tệp đó trước khi "dò" được tệp kế
\end{enumerate}
