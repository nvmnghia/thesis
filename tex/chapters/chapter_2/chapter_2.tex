...
\begin{itemize}
    ...
    \item
        ...
        % The above line is narrower due to the shitty wrapfig, and only it is.
        % However, if the whole item is moved to the below part, the whole list
        % is narrowed.
\end{itemize}
    ...
    \item
        ...
        \begin{itemize}
            ...
            \item
                ...
                vừa \cite{WIKI_ZIP}. Cách sửa tệp linh động này cho phép chỉ ghi
                lại dữ liệu ở một số đĩa mềm, thay vì ghi lại toàn bộ.
            \item
