...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false]{../images/read_permission_mvvm_class.svg}
...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false]{../images/library_mvvm_class.svg}
...
\begin{figure}[H]
    \centering
    \includesvg[width=0.7\linewidth,inkscapelatex=false]
...
\begin{figure}[H]
    \centering
    \includesvg[width=0.5\linewidth,inkscapelatex=false]
