...
\IfEq{\jobname}{\detokenize{thesis}}{}{%
    \StrBehind{\getrefnumber{sec:module-view}}{.}[\tempsectioncounter]
    \setcounter{section}{\tempsectioncounter}
    \addtocounter{section}{-1}
}

\IfEq{\jobname}{\detokenize{thesis}}{}{%
    \StrBehind{\getrefnumber{fig:3-models}}{.}[\tempfigurecounter]
    \setcounter{figure}{\tempfigurecounter}
    \addtocounter{figure}{-1}
}

\IfEq{\jobname}{\detokenize{thesis}}{}{%
    \StrBehind{\getrefnumber{tab:3-models}}{.}[\temptablecounter]
...
truy cập để lấy \texttt{InputStream} của ảnh từ \texttt{ComicID} có thể xem ở
Màn hình Đọc truyện.
...
nếu cần. Hiện tại, Repository không làm được nhiều, tuy nhiên nó tăng \emph{khả
năng mở rộng} của ứng dụng. Ví dụ, trong tương lai yacv có thể liên kết với một
bên thứ ba cung cấp metadata cho truyện, khi đó để tích hợp API thì chỉ cần sửa
phần Repository.
...
gợi ý, bên cạnh hiển thị danh sách thư mục. Do đó, phần này chia ra làm hai phần
con tương ứng.
...
có thể xem ở Màn hình Đọc truyện.
...
Đây là màn hình thứ ba trong chuỗi các màn hình liên quan đến ca sử dụng tìm
kiếm, đồng thời đóng vai trò của Màn hình Thư mục (do là phiên bản tổng quát hơn
của nó).
...
hình Thư viện}. Do trang truyện cũng dọc, cần thu nhỏ kích cỡ phần tử bằng cách
một dòng cho hiển thị 2-3 phần tử.
