...
Cũng cần nói thêm rằng thuật toán này là kiểu \emph{tham lam} (greedy), không
phải thuật toán tối ưu nhất. Thuật toán này có hai lợi thế:

\begin{itemize}
    \item Đơn giản
    \item Giới hạn được số luồng nhập:
\end{itemize}
