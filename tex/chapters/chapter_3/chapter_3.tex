...
\protect\hyperlink{P3.3.2-show-library}{ca sử dụng tiếp theo}.
...
kiện cho) \protect\hyperlink{P3.3.3-read-comic}{ca sử dụng đọc truyện} sẽ được
miêu tả tiếp theo.
...
\begin{itemize}
    \item
        ...
        đã mô tả ở trong \protect\hyperlink{P3.3.3-read-comic}{ca sử dụng đọc
        truyện}).
    \item
