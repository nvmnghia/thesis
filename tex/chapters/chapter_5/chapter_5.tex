...
Sử dụng Profiler tích hợp trong Android Studio, ta đo thời gian quét thư viện.
Thời gian quét thư viện thể hiện được sự cải thiện tốc độ của \texttt{CBZParser}
vì khi quét thư viện, từng tệp truyện phải được quét để tìm metadata. Baseline
của so sánh này là cách cơ bản thứ hai trong \autoref{sec:cbzparser_design}.

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.55]{../images/simple_cbz.png}
    \caption{Baseline}
    \label{fig:simple_cbz}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.55]{../images/fast_cbz.png}
    \caption{Tối ưu}
    \label{fig:fast_cbz}
\end{figure}

Ta có thể thấy với cách tối ưu, \texttt{CBZParser} có tốc độ nhanh hơn 8 lần so
với cách đơn giản, vốn đọc và giải nén thừa rất nhiều.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[scale=0.117]{../images/Screenshot_2021-05-25-07-55-58-349_com.uet.nvmnghia.yacv}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[scale=0.117]{../images/Screenshot_2021-05-25-07-56-08-965_com.uet.nvmnghia.yacv}
